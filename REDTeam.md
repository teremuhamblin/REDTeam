...
| 🧠 Approche | Simulation d’un adversaire crédible |
| 🕵️ Furtivité | OPSEC strict, actions discrètes |
| 🛡️ Impact | Amélioration de la posture de sécurité |
| 📜 Cadre | ROE, périmètre, limites, validation légale |
| 🔬 Méthodologie | Alignée MITRE ATT&CK & Kill Chain |
...
| **Initial Access** | Simulation d’un vecteur d’entrée autorisé |
| **Élévation de privilèges** | Analyse des permissions et escalade contrôlée |
| **Mouvement latéral** | Exploration interne sous contraintes ROE |
| **Persistance** | Maintien d’accès (selon autorisation) |
| **Actions sur objectifs** | Validation d’un scénario métier |
| **Rapport & débriefing** | Analyse stratégique, recommandations |
...
| Approche | Adversaire réaliste | Technique et exhaustive |
| Durée | Longue (semaines/mois) | Courte (jours/semaines) |
| Furtivité | Oui | Non |
| Teste la détection | Oui | Non |
| Teste la réaction | Oui | Non |
...
| **Rapport technique** | Détails des scénarios, chemins d’accès |
| **Tableau MITRE** | Techniques utilisées (Txxxx) |
| **Plan d’amélioration** | Correctifs, priorités, roadmap sécurité |
...
- une traçabilité interne  

Aucune action n’est réalisée hors cadre ou sans autorisation.
